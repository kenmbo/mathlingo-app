...
Goal: create enough project documentation for future implementation sessions to build from without guessing.

## Milestone 0: Planning Docs

Scope:

- [x] Rewrite `README.md` with project context, setup, and backend expectations.
